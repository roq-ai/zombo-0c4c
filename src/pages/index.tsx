  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the ease of healthcare with ZOMBO - Your ultimate solution for finding nearby doctors in times of emergency."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1605684954998-685c79d6a018?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkb2N0b3IlMkNlbWVyZ2VuY3l8ZW58MHx8fHwxNjg5NzY3NjMyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of healthcare with ZOMBO - Your ultimate solution for finding nearby doctors in times of emergency.`}
            </Text>
            <Box
