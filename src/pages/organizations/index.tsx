...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'doctor.count', 'favorite_organization.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('doctor', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('favorite_organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'favorite_organization',
          header: 'Favorite Organization',
          accessorKey: 'favorite_organization',
          cell: ({ row: { original: record } }: any) => record?._count?.favorite_organization,
        }
      : null,
