...
import { getFavoriteOrganizationById } from 'apiSdk/favorite-organizations';
import { FavoriteOrganizationInterface } from 'interfaces/favorite-organization';

function FavoriteOrganizationViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Favorite Organization Details',
              isCurrent: true,
            },
          ]}
        />
